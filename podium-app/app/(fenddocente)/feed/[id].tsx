...
export default function EvaluateProjectScreen() {
    ...
    const [criterios, setCriterios] = useState<CriterioState[]>(() =>
        DEFAULT_RUBRICA.map((c) => ({
            ...
            obtenido: Math.round(c.puntos_max * 0.8),
            obs: "",
        }))
    );
            ...
            >
                ...
                <View style={styles.projectCard}>
                    ...
                    <Text style={styles.projectMeta}>
                        {project.authorName}{project.category ? ` · ${project.category}` : ""}
                    </Text>
                    ...
                    <View style={styles.evidCard}>
                        ...
                        {ev?.videos?.length > 0 && ev.videos.map((v, i) => (
                            <View key={i} style={{ gap: 4 }}>
                                <Text style={{ fontSize: 12, fontWeight: "700", color: colors.mutedForeground, textTransform: "uppercase", letterSpacing: 0.6 }}>{v.titulo}</Text>
